const campaignMessageAction = (() => {
    ...
    return {
        ...
        save: async function() {
            ...
            const pcHtml = campaignMessageAction.setReplaceSrc(document.querySelector('#campaignMessagePreviewLaptop .campaign-popup').outerHTML);
            const moHtml = campaignMessageAction.setReplaceSrc(document.querySelector('#campaignMessagePreviewMobile .campaign-popup').outerHTML);
        ...
        showHisMessage: function() {
            ...
            Popup.open(`/campaign/popup/historyMessage?acl=${acl}&msgType=${msgType}`, 'contentPopupMessageAction');
        },
