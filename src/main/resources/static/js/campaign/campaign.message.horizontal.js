const campaignMessageHorizontal = (() => {
    ...
    return {
        ...
        setMsgContents: function(e) {
            ...
            const view = element.querySelector('.board-summary');
                if(elem.id == 'msgContents') {
                    campaignMessageHorizontal.setContentsRow(e);
        ...
        setDisplay: function(e) {
            ...
            if(elem.id == 'msgReviewTf') {
                ...
                campaignMessageHorizontal.setPreviewButton();
        ...
        save: async function() {
            ...
            const pcHtml = campaignMessageHorizontal.setReplaceSrc(document.querySelector('#campaignMessagePreviewLaptop .campaign-popup').outerHTML);
            const moHtml = campaignMessageHorizontal.setReplaceSrc(document.querySelector('#campaignMessagePreviewMobile .campaign-popup').outerHTML);
        ...
        showHisMessage: function() {
            ...
            Popup.open(`/campaign/popup/historyMessage?acl=${acl}&msgType=${msgType}`, 'contentPopupMessageHorizontal');
        },
...
campaignMessageHorizontal.init();